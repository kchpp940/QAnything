export default {
  ...
  common: {
    ...
    webSearchPolicy: 'Web Search Policy',
    webSearchPolicyDescription: 'Choose when to trigger web search',
    webSearchPolicyDisabled: 'Disabled',
    webSearchPolicyDisabledDescription: 'Never use web search, answer based only on local knowledge base',
    webSearchPolicyManual: 'Manual Only',
    webSearchPolicyManualDescription: 'Only perform web search when user manually enables it',
    webSearchPolicyLowRecall: 'Low Recall Trigger',
    webSearchPolicyLowRecallDescription: 'Auto trigger web search when local recall is insufficient',
    webSearchPolicyAlways: 'Always On',
    webSearchPolicyAlwaysDescription: 'Always use web search for more comprehensive results',
    trustLevelHigh: 'High Trust',
    trustLevelMedium: 'Medium Trust',
    trustLevelLow: 'Low Trust',
    sourceTypeLocal: 'Local Knowledge Base',
    sourceTypeWeb: 'Web Search',
    webSearchResultRatio: 'Web Results Ratio',
    webSearchEnabled: 'Web Search Enabled',
    webSearchDisabled: 'Web Search Disabled',
    manualWebSearch: 'This Query Web Search',
    manualWebSearchDescription: 'Enable web search for this query only; does not affect subsequent queries',
    triggerReasonLabel: 'Trigger Reason',
    triggerReasonPolicyAlways: 'Policy: Always Web Search',
    triggerReasonPolicyLowRecall: 'Policy: Low Recall Triggered',
    triggerReasonPolicyManual: 'User Manually Enabled',
    triggerReasonSkippedDisabled: 'Policy: Web Search Disabled',
    triggerReasonSkippedManualOff: 'Policy: Manual Mode (Not Enabled)',
    triggerReasonSkippedHighRecall: 'Sufficient Local Recall, No Web Search Needed',
    localRecallScore: 'Local Recall Score',
    webResultCount: 'Web Result Count',
    webExecutionTime: 'Web Search Time',
    sourceGroupLocal: 'Local Knowledge Base Sources',
    sourceGroupWeb: 'Web Search Sources',
    noWebResults: 'No Web Sources',
    noLocalResults: 'No Local Sources',
    mixedSearch: 'Mixed',
