export default {
  ...
  bots: {
    ...
    selectTemplate: 'Select scene template',
    templateDesc:
      'Selecting a template will auto-fill prompts, retrieval params and capability switches',
    noTemplate: 'No template',
    customerService: 'Customer Service',
    enterpriseKnowledge: 'Enterprise Knowledge',
    codeDocAssistant: 'Code Doc Assistant',
    strictCitation: 'Strict Citation',
    answerStyle: 'Answer Style',
    answerStyleConcise: 'Concise',
    answerStyleDetailed: 'Detailed',
    answerStyleTechnical: 'Technical',
    answerStyleStrictCitation: 'Strict Citation',
    templateDefault: 'Template default',
    userModified: 'Customized',
    resetToDefault: 'Reset to default',
    templateApplied: 'Template applied',
    templateReset: 'Reset to template defaults',
  },
  progress: {
