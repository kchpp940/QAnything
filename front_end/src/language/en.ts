export default {
  ...
  common: {
    ...
    traceOriginalQuery: 'Original Query',
    traceRetrievalQuery: 'Retrieval Query',
    traceStage: 'Stage',
    traceRetrievalScore: 'Retrieval Score',
    traceRerankScore: 'Rerank Score',
    traceStatus: 'Status',
    traceSelected: 'Selected',
    traceFiltered: 'Filtered',
    traceFilterReason: 'Filter Reason',
    traceStageRetrieval: 'Vector Retrieval',
    traceStageWebSearch: 'Web Search',
    traceStageRerank: 'Rerank',
    traceStageTopK: 'TopK Filter',
    traceStageFAQ: 'FAQ Match',
    traceStagePrompt: 'Prompt Assembly',
    traceSelectedSources: 'Selected Sources',
    traceFilteredCandidates: 'Filtered Candidates',
    traceAllCandidates: 'All Candidates',
    traceFinalSelected: 'Finally Selected',
    traceFinalFiltered: 'Not Selected',
    tracePromptPosition: 'Prompt Position',
    traceNotInStage: 'Not in this stage',
    traceSelectedInStage: 'Selected in this stage',
    traceFilteredInStage: 'Filtered in this stage',
    traceViewDetail: 'View Details',
    traceHideDetail: 'Hide Details',
    traceNoCandidates: 'No candidates',
