export default {
  ...
  common: {
    ...
    close: '关闭',
    updesc1:
      '支持文件格式md、txt、pdf、jpg、png、jpeg、doc、docx、xls、xlsx、ppt、pptx、eml、csv、jsonl(只支持单层key:value), 单个文档小于30M, 单张图片小于5M, 文件总大小不得超过125M',
    updesc2:
    ...
    webSearchPolicy: '联网检索策略',
    webSearchPolicyDescription: '选择联网检索的触发方式',
    webSearchPolicyDisabled: '禁用联网',
    webSearchPolicyDisabledDescription: '完全不使用联网搜索，仅基于本地知识库回答',
    webSearchPolicyManual: '手动开启',
    webSearchPolicyManualDescription: '仅在用户手动点击联网按钮时进行联网搜索',
    webSearchPolicyLowRecall: '低召回联网',
    webSearchPolicyLowRecallDescription: '当本地知识库召回结果不足时，自动补充联网搜索结果',
    webSearchPolicyAlways: '始终联网',
    webSearchPolicyAlwaysDescription: '每次回答都联网搜索，结果更全面但速度较慢',
    trustLevelHigh: '高可信',
    trustLevelMedium: '中等可信',
    trustLevelLow: '低可信',
    sourceTypeLocal: '本地知识库',
    sourceTypeWeb: '联网搜索',
    webSearchResultRatio: '联网结果占比',
    webSearchEnabled: '联网已开启',
    webSearchDisabled: '联网已关闭',
    manualWebSearch: '本次联网',
    manualWebSearchDescription: '开启后，使用，关闭不影响下次请求',
    triggerReasonLabel: '触发原因',
    triggerReasonPolicyAlways: '策略：始终联网',
    triggerReasonPolicyLowRecall: '策略：低召回触发',
    triggerReasonPolicyManual: '用户手动开启',
    triggerReasonSkippedDisabled: '策略：已禁用联网',
    triggerReasonSkippedManualOff: '策略：手动模式但未开启',
    triggerReasonSkippedHighRecall: '本地召回充足，无需联网',
    localRecallScore: '本地召回分',
    webResultCount: '联网结果数',
    webExecutionTime: '联网耗时',
    sourceGroupLocal: '本地知识库来源',
    sourceGroupWeb: '联网搜索来源',
    noWebResults: '无联网来源',
    noLocalResults: '无本地来源',
    mixedSearch: '混合检索',
  ...
  home: {
    ...
    startDec: '上传文档 发起提问',
    updesc2:
      '支持md、txt、pdf、jpg、png、jpeg、doc、docx、xls、xlsx、ppt、pptx、eml、csv、jsonl(只支持单层key:value)',
    require1: '可批量上传, 单个文档小于30M, 单张图片小于5M, 文件总大小不得超过125M',
    emptyText: '暂无数据',
    inputQa: '录入问答',
