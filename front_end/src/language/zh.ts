export default {
  ...
  common: {
    ...
    correlation: '相关性:',
    traceDetail: '溯源详情',
    traceOriginalQuery: '原始问题',
    traceRetrievalQuery: '检索问题',
    traceStage: '阶段',
    traceRetrievalScore: '检索分数',
    traceRerankScore: 'Rerank分数',
    traceStatus: '状态',
    traceSelected: '入选',
    traceFiltered: '过滤',
    traceFilterReason: '过滤原因',
    traceStageRetrieval: '向量检索',
    traceStageWebSearch: '联网搜索',
    traceStageRerank: '重排序',
    traceStageTopK: 'TopK截断',
    traceStageFAQ: 'FAQ匹配',
    traceStagePrompt: 'Prompt拼接',
    traceSelectedSources: '入选来源',
    traceFilteredCandidates: '被过滤候选',
    traceAllCandidates: '全部候选',
    traceFinalSelected: '最终入选',
    traceFinalFiltered: '最终未入选',
    tracePromptPosition: 'Prompt位置',
    traceNotInStage: '未参与该阶段',
    traceSelectedInStage: '本阶段入选',
    traceFilteredInStage: '本阶段过滤',
    traceViewDetail: '查看详情',
    traceHideDetail: '收起详情',
    traceNoCandidates: '暂无候选',
    copySuccess: '拷贝成功',
    copyFailed: '拷贝失败',
    copied: '拷贝过',
    copy: '拷贝',
