export default {
  ...
  bots: {
    ...
    creationTime: '创建时间',
    sceneTemplate: '场景模板',
    selectTemplate: '选择场景模板',
    templateDesc: '选择模板将自动填充提示词、检索参数和能力开关',
    noTemplate: '不使用模板',
    customerService: '客服问答',
    enterpriseKnowledge: '企业知识助手',
    codeDocAssistant: '代码文档助手',
    strictCitation: '严谨引用模式',
    answerStyle: '回答风格',
    answerStyleConcise: '简洁',
    answerStyleDetailed: '详尽',
    answerStyleTechnical: '技术性',
    answerStyleStrictCitation: '严谨引用',
    templateDefault: '模板默认',
    userModified: '已自定义',
    resetToDefault: '恢复模板默认',
    templateApplied: '模板已应用',
    templateReset: '已恢复模板默认值',
  },
  progress: {
