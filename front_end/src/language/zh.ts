export default {
  ...
  common: {
    ...
    retrySuccess: '重试已启动',
    retryFailed: '重试启动失败',
    cannotRetry: '该文件不支持重试',

    errorUnknown: '未知错误',
    errorUploadFailed: '上传失败',
    errorParseFailed: '文件解析失败',
    errorParseTimeout: '解析超时',
    errorParseUnsupported: '不支持的文件格式',
    errorParseCorrupted: '文件损坏或无法读取',
    errorChunkFailed: '文本切分失败',
    errorMilvusConnection: '向量数据库连接失败',
    errorMilvusInsert: '向量数据库写入失败',
    errorMilvusTimeout: '向量数据库操作超时',
    errorEsConnection: '搜索引擎连接失败',
    errorEsIndex: '索引创建失败',
    errorEsTimeout: '索引操作超时',
    errorRollback: '回滚操作失败',
    errorCleanup: '清理残留数据失败',
    cleanupFailuresTitle: '残留数据未清干净',
    leftResidual: '残留数量',
    reason: '原因',
